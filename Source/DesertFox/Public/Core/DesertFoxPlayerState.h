...
#include "DesertFoxPlayerState.generated.h"

/**
 * 
 */
UCLASS()
class DESERTFOX_API ADesertFoxPlayerState : public APlayerState
{
	GENERATED_BODY()

public:
	ADesertFoxPlayerState();
...
protected:
	...
	virtual void RunOutStamina(class ADesertFoxCharacter* DesertFoxCharacter);
	/** Call this function when the stamina is full */
	virtual void FillUpStamina(class ADesertFoxCharacter* DesertFoxCharacter);
